...
public class Servidor {
    public static void main(String args[]) {
        ...
        try{
            ...
            System.err.println("No puedo saber la dirección IP local: "+uhe); //es lo mismo
        }
        ...
        //Bucle infinito
        while (true){ //mientras no se produzca un error el servidor no se cierra
            try{
